...
ALTER TABLE tb_estoque ADD CONSTRAINT PK_tb_estoque PRIMARY KEY (cod_prod_est,cpf);
...
ALTER TABLE tb_pop ADD CONSTRAINT PK_tb_pop PRIMARY KEY (cod_pop,cpf);
...
ALTER TABLE tb_cadastramento ADD CONSTRAINT PK_tb_cadastramento PRIMARY KEY (cod_prod,cpf_prof);
...
ALTER TABLE tb_expedicao ADD CONSTRAINT PK_tb_expedicao PRIMARY KEY (cod_prod_exp,cod_prod,cpf,cpf_prof);
...
ALTER TABLE tb_picking ADD CONSTRAINT PK_tb_picking PRIMARY KEY (cod_produto,cod_prod,cpf_prof);
...
ALTER TABLE tb_rnc ADD CONSTRAINT PK_tb_rnc PRIMARY KEY (desc_nc,cod_prod,cpf,cpf_prof);
...
ALTER TABLE tb_expedicao ADD CONSTRAINT FK_tb_expedicao_0 FOREIGN KEY (cod_prod,cpf_prof) REFERENCES tb_cadastramento (cod_prod,cpf_prof);
ALTER TABLE tb_expedicao ADD CONSTRAINT FK_tb_expedicao_1 FOREIGN KEY (cpf) REFERENCES tb_aluno (cpf);


ALTER TABLE tb_picking ADD CONSTRAINT FK_tb_picking_0 FOREIGN KEY (cod_prod,cpf_prof) REFERENCES tb_cadastramento (cod_prod,cpf_prof);


ALTER TABLE tb_rnc ADD CONSTRAINT FK_tb_rnc_0 FOREIGN KEY (cod_prod,cpf_prof) REFERENCES tb_cadastramento (cod_prod,cpf_prof);
ALTER TABLE tb_rnc ADD CONSTRAINT FK_tb_rnc_1 FOREIGN KEY (cpf) REFERENCES tb_aluno (cpf);
